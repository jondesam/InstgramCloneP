...
public class SharedPictureTab extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageShare.setOnClickListener(SharedPictureTab.this);
        buttonShareImage.setOnClickListener(SharedPictureTab.this);
    ...
    private void getChosenImage() {
        //FancyToast.makeText(getContext(),"Image selected", Toast.LENGTH_SHORT,FancyToast.SUCCESS,true).show();
